...
myGuy = Character()
myGuy.setAC()
print(myGuy.getRace().getAttributes())
print(myGuy.getRace().getModifiers())
stuff = myGuy.getClass().getSkills()
for thing in stuff:
    if thing == Knowledge or thing == Profession or thing == Preform:
